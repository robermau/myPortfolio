...
import contact from '../assets/contactme.jpg'
 ...
 function ContactMe  ()  {
  return (
    <>
    <Link className="flex-col pt-10 flex"to='/'>
    <div className='text-white font-medium flex  pl-10 pt-10 items-center absolute '>
    ...
    <div className='flex flex-col justify-center bg-slate-400 items-center  mt-32'>
      
      <img className='absolute -z-10  ' src={contact}/>
